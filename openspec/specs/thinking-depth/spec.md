...
Defines thinking-depth controls in the playground and chat API: model-aware effort stops, hiding unsupported models, collapsible reasoning content, and upstream parameter forwarding.
